  ...
  //  [SerializeField] private Image bicycleProgressLevel1, bicycleProgressLevel2, bicycleProgressLevel3, bicycleProgressLevel4, bicycleProgressLevel5;
   ...
   // [SerializeField] private TextMeshProUGUI runningProgressPercentLevel1, runningProgressPercentLevel2, runningProgressPercentLevel3, runningProgressPercentLevel4, runningProgressPercentLevel5;
    ...
    private void Start()
    {
        ...
        {
            if (Geekplay.Instance.PlayerData.RunningSaveProgressLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.RunningSaveProgressMenuLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.RunningFillAmountLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.BestRunningMapSecondsLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.CurrentRunningMapMinutesLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.CurrentRunningMapSecondsLevels.Length != 5)
            {
        ...
        {
            if(Geekplay.Instance.PlayerData.BicycleSaveProgressLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.BicycleSaveProgressMenuLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.BicycleFillAmountLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.BestBicycleMapSecondsLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.CurrentBicycleMapMinutesLevels.Length != 5)
            {
        ...
        {
            if (Geekplay.Instance.PlayerData.CurrentBicycleMapSecondsLevels.Length != 5)
            {
    ...
    public void PressedRunMenu()
    {
        ...
        for (int i = 0; i < Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels.Length; i++)
        {
            if (Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i] < 10)
            {
                if (Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i] < 10)
                {
                    runningTimerLevels[i].text = "0" + Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString() + "." + "0" + Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString("F2", culture);
                }
                else
                {
                    runningTimerLevels[i].text = "0" + Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString() + "." + Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString("F2", culture);
                }
            }
            if (Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[Geekplay.Instance.PlayerData.RunningMapIndex] >= 10)
            {
                if (Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[Geekplay.Instance.PlayerData.RunningMapIndex] < 10)
                {
                    runningTimerLevels[i].text = Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString() + "." + "0" + Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString("F2", culture);
                }
                else
                {
                    runningTimerLevels[i].text = Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString() + "." + Geekplay.Instance.PlayerData.BestRunningMapMinutesLevels[i].ToString("F2", culture);
                }
            }
        }
        /////// Level 1 
    ...
    {       
        ...
        for (int i = 0; i < Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels.Length; i++) {
            if (Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i] < 10)
            {
                if (Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i] < 10)
                {
                    bicycleTimerLevels[i].text = "0" + Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString() + "." + "0" + Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString("F2", culture);
                }
                else
                {
                    bicycleTimerLevels[i].text = "0" + Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString() + "." + Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString("F2", culture);
                }
            }
            if (Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[Geekplay.Instance.PlayerData.BicycleMapIndex] >= 10)
            {
                if (Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[Geekplay.Instance.PlayerData.BicycleMapIndex] < 10)
                {
                    bicycleTimerLevels[i].text = Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString() + "." + "0" + Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString("F2", culture);
                }
                else
                {
                    bicycleTimerLevels[i].text = Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString() + "." + Geekplay.Instance.PlayerData.BestBicycleMapMinutesLevels[i].ToString("F2", culture);
                }
            } 
        }
        //// Level 1
    ...
    public void PressedContinueRun()
    {
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneRunning 1 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneRunning 2 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneRunning 3 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneRunning 4 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneRunning 5 Continue_Game");
    ...
    public void PressedContinueBicycle()
    {
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneBicycle 1 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneBicycle 2 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneBicycle 3 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneBicycle 4 Continue_Game");
        ...
        //        Geekplay.Instance.Save();
        //    }
        //    Analytics.instance.SendEvent("SampleSceneBicycle 5 Continue_Game");
    ...
    public void PressedNewGameRun()
    {
        ...
        //    Geekplay.Instance.PlayerData.RunningSaveProgressLevel1 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneRunning 1 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneRunning 1");
        //}
        //if (Geekplay.Instance.PlayerData.RunningMapIndex == 2)
        //{
        ...
        //    Geekplay.Instance.PlayerData.RunningSaveProgressLevel2 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneRunning 2 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneRunning 2");
        //}
        //if (Geekplay.Instance.PlayerData.RunningMapIndex == 3)
        //{
        ...
        //    Geekplay.Instance.PlayerData.RunningSaveProgressLevel3 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneRunning 3 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneRunning 3");
        //}
        //if (Geekplay.Instance.PlayerData.RunningMapIndex == 4)
        //{
        ...
        //    Geekplay.Instance.PlayerData.RunningSaveProgressLevel4 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneRunning 4 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneRunning 4");
        //}
        //if (Geekplay.Instance.PlayerData.RunningMapIndex == 5)
        //{
        ...
        //    Geekplay.Instance.PlayerData.RunningSaveProgressLevel5 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneRunning 5 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneRunning 5");
        //}
    }
    public void PressedNewGameBicycle()
    {
        ...
        //    Geekplay.Instance.PlayerData.BicycleSaveProgressLevel1 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneBicycle 1 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneBicycle 1");
        //}
        //if (Geekplay.Instance.PlayerData.BicycleMapIndex == 1)
        //{
        ...
        //    Geekplay.Instance.PlayerData.BicycleSaveProgressLevel2 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneBicycle 2 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneBicycle 2");
        //}
        //if (Geekplay.Instance.PlayerData.BicycleMapIndex == 2)
        //{
        ...
        //    Geekplay.Instance.PlayerData.BicycleSaveProgressLevel3 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneBicycle 3 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneBicycle 3");
        //}
        //if (Geekplay.Instance.PlayerData.BicycleMapIndex == 3)
        //{
        ...
        //    Geekplay.Instance.PlayerData.BicycleSaveProgressLevel4 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneBicycle 4 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneBicycle 4");
        //}
        //if (Geekplay.Instance.PlayerData.BicycleMapIndex == 4)
        //{
        ...
        //    Geekplay.Instance.PlayerData.BicycleSaveProgressLevel5 = 0;
        //    Geekplay.Instance.Save();
        //    Analytics.instance.SendEvent("SampleSceneBicycle 5 Start_New_Game");
        //    SceneManager.LoadScene("SampleSceneBicycle 5");
        //}
    }
